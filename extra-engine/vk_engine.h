...
struct FrameData {
	...
	//debugeOutputBuffer -> storage VkDrawIndexedIndirectCommand,draw object id and batch id;
...
public:
	...
	AllocatedImage _colorResourceImage;
	...
	//pyramid depth used for Hierarchical z-buffer Occlusion Culling
