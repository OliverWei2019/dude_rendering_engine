...
private:
	...
	glm::vec4   m_planes[Count]; //6 frustun Plane Equation
	glm::vec3   m_points[8];// 8 frustum vertex 
};
//input a M = P*V matrix and output a frustum
inline Frustum::Frustum(glm::mat4 m)
{
	...
	//3 plane intersection determine a vertex
...
// http://iquilezles.org/www/articles/frustumcorrect/frustumcorrect.htm
//determine whether cull boxes of outside frustum or not? 
